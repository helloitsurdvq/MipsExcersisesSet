# Print the sum of even and odd elements in an array
.data
	A: .space 100
	Aend: .word 
	Message1: .asciiz "Enter array size: "
	Message2: .asciiz "Enter the element: " 
	res1: .asciiz "Sum of even element: "
	res2: .asciiz "Sum of odd element: "
	ms: .asciiz " "
	line: .asciiz "\n"
...
loop: 
	...
	rem $t8, $s7, 2 # check the remainder of each element
	beqz $t8, sumEven # add sumEven
	bnez $t8, sumOdd # add sumOdd
